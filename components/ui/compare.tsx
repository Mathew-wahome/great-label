  ...
  return (
    ...
    >
      <AnimatePresence initial={false}>
        ...
        >
          <div className="w-36 h-full [mask-image:radial-gradient(100px_at_left,white,transparent)] absolute top-1/2 -translate-y-1/2 left-0 bg-gradient-to-r from-white/50 via-transparent to-transparent z-20 opacity-50" />
          ...
          {showHandlebar && (
            <div className="h-5 w-5 rounded-md top-1/2 -translate-y-1/2 bg-black z-30 -right-2.5 absolute flex items-center justify-center border border-gray-500/80">
