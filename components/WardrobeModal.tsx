...
const WardrobePanel: React.FC<WardrobePanelProps> = ({ onGarmentSelect, activeGarmentIds, isLoading, wardrobe }) => {
  ...
  return (
    <div className="pt-6 border-t border-gray-600/50">
        <h2 className="text-xl font-serif tracking-wider text-gray-100 mb-3">Wardrobe</h2>
        <div className="grid grid-cols-3 gap-3">
            ...
            return (
                ...
                className="relative aspect-square border border-gray-700 rounded-lg overflow-hidden transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-black focus:ring-gray-300 group disabled:opacity-60 disabled:cursor-not-allowed"
            ...
            <label htmlFor="custom-garment-upload" className={`relative aspect-square border-2 border-dashed border-gray-600 rounded-lg flex flex-col items-center justify-center text-gray-500 transition-colors ${isLoading ? 'cursor-not-allowed bg-gray-800' : 'hover:border-gray-500 hover:text-gray-400 cursor-pointer'}`}>
