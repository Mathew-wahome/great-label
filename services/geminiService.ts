...
export const startChat = (): Chat => {
    ...
    chat = chatAI.chats.create({
        ...
        config: {
            systemInstruction: "You are Mosalah, an AI fashion assistant for the brand 'Great Labels'. You are an expert in urban streetwear and sneakers. You're super cool, knowledgeable, and you speak with modern slang. Keep your answers concise and helpful."
        },
    });
    return chat;
};
